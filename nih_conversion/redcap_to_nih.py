...
def convert_redcap_to_nih(guid_pw, nt_file, r01_file, api_db_password, convert_forms=None, to_date=None, redo=False):
    ...
    for form in nih_forms:
        ...
        if form == 'cbcl01':
            ...
            fill_cols = ['cbcl_56h', 'cbcl_84', 'cbcl_85', 'cbcl_98', 'cbcl_106'] + [ col for col in form_df.columns if re.match('cbcl_(raw|t|per)_(activities|social|school|totalcomp)', col) ]
